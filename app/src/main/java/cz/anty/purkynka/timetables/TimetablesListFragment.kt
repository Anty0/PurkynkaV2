...
package cz.anty.purkynka.timetables
...
class TimetablesListFragment : NavigationFragment(), TitleProvider, ThemeProvider {

    override val title: CharSequence
        get() = getText(R.string.title_fragment_timetables_list)
    override val themeId: Int
        get() = R.style.AppTheme_Timetables
